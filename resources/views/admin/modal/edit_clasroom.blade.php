        ...
        <div class="modal-content">
            <form id="editCourseForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="edit_durasi" class="form-label">Durasi Kursus<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="edit_durasi" name="durasi"
                            placeholder="Durasi kursus">
                    </div>
                    <div class="mb-3">
                        <label for="edit_sertifikat" class="form-label">Sertifikat<span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="edit-include-container">
                            <!-- Tempat untuk menampilkan item yang akan dipelajari -->
                        </div>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" id="edit_include"
                                placeholder="Tambahkan item yang akan dipelajari">
                            <button class="btn btn-success" type="button" id="add-edit-include">Tambah</button>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-secondary">Catatan: Isi dengan tags kursus yang relevan</small>
                    </div>
                </div>
                    ...
                    data.include.forEach(item => {
                        const inputGroup = $(`
                            <div class="input-group mb-2">
                                ...
                                <button class="btn btn-danger remove-edit-include" type="button">Hapus</button>
                            </div>
                        `);
