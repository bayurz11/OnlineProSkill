            ...
            <form action="{{ route('storeclas') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3" hidden>
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="course_type" id="produk"
                                value="produk" checked>
                            <label class="form-check-label" for="produk">
                                Produk
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="nama_kursus" class="form-label">Nama Produk<span
