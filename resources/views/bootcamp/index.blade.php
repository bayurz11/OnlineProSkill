    ...
    <section class="banner-area banner-bg tg-motion-effects"
        ...
        <div class="container" style="width: 90%; max-width: 1200px; padding-left: 5%; padding-right: 5%; height: auto;">
            <div class="row justify-content-between align-items-start" style="display: flex; flex-wrap: wrap;">
                ...
                <div class="col-lg-5" style="position: relative; width: 100%;"> <!-- Sesuaikan lebar kontainer -->
                    <div class="banner__images"
                        style="position: relative; display: flex; justify-content: center; align-items: center; margin-top: 50px; margin-left: 0px;">
                        <!-- Kurangi margin di mobile -->
                        <!-- Background Image -->
                        <img src="public/assets/img/banner/banner2.jpg" alt="img" class="main-img" data-aos="fade-left"
                            data-aos-delay="800" style="width: 100%; height: auto; border-radius: 5px;">
                        <!-- Ubah ukuran gambar -->

                        <!-- Decorative Background Dots -->
                        <img src="public/assets/img/banner/bg_dots.svg" alt="shape" class="shape bg-dots rotateme"
                            data-aos="fade-left" data-aos-delay="600" style="display: none;"> <!-- Sembunyikan dekorasi -->

                        <!-- Background Gradient -->
                        <div
                            style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; width: 100%; height: 100%; background: linear-gradient(to bottom, transparent, white); z-index: 1; pointer-events: none;">
                        </div>
                        ...
                        <div
                            ...
                            <span style="font-size: 14px; color: #000; font-weight: bold; margin-bottom: 8px;"
                            ...
                            <span style="font-size: 14px; color: #000; font-weight: bold; margin-top: 8px;"
                    ...
                    <div class="banner__student" data-aos="fade-left" data-aos-delay="200"
                        style="z-index: 100; margin-top: 20px;"> <!-- Kurangi margin-top -->
                        <div class="icon">
                            <img src="{{ asset('public/assets/img/banner/h2_banner_icon.svg') }}" alt="img"
                                class="injectable" style="width: 50px;"> <!-- Perkecil ukuran ikon -->
                        </div>
                        <div class="content">
