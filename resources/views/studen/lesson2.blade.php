    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelector('.prev-button').addEventListener('click', function() {
                ...
                // Setelah memperbarui video, juga memperbarui konten kurikulum
                updateKurikulum();
            });
            ...
            // Fungsi untuk memperbarui konten kurikulum
            function updateKurikulum() {
                ...
                fetch(`/course-content/${courseId}`)
                    .then(response => response.text())
                    .then(html => {
                        kurikulumContainer.innerHTML = html; // Mengganti konten kurikulum
                    })
                    .catch(error => {
                        console.error('Error:', error);
                    });
                ...
                fetch(`/sectionupdatestatus/${sectionId}`, {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            // Memperbarui kurikulum setelah menandai selesai
                            updateKurikulum();
                        } else {
                            console.error('Gagal memperbarui status.');
                        }
