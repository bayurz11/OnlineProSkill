...
class HomeController extends Controller
{
    ...
    public function classroomdetail($slug)
    {
        ...
        $profile = null;
        $cart = Session::get('cart', []);
        $kurikulum = Kurikulum::with('user')->whereHas('kelasTatapMuka', function ($query) use ($slug) {
        ...
        $courses = KelasTatapMuka::where('slug', $slug)->first();
    ...
    public function checkout(Request $request, $slug)
    {
        ...
        $courses = KelasTatapMuka::whereIn('slug', array_column($cart, 'slug'))->get();
