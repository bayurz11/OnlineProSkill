            ...
            <div class="row justify-content-between align-items-start" style="display: flex; flex-wrap: wrap;">
                ...
                <div class="col-lg-5" style="position: relative;">
                    <div class="banner__images"
                        ...
                        <!-- Background Gradient -->
                        <div
                            style="position: absolute; bottom: 0; left: 0; right: 0; height: 400px; width:100px; background: linear-gradient(to bottom, transparent, white); z-index: 1; pointer-events: none;">
                        </div>
