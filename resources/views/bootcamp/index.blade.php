        ...
        <div class="container" style="width: 90%; max-width: 1200px; padding-left: 5%; padding-right: 5%; height: auto;">
            <div class="row justify-content-between align-items-start" style="display: flex; flex-wrap: wrap;">
                <div class="col-xl-12 col-lg-12 col-md-12" style="flex: 1; padding-left: 0;">
                    ...
                    <div class="row align-items-center" data-aos="fade-top" data-aos-delay="600">
                        <div class="col-12 col-md d-flex align-items-center mb-3 mb-md-0">
                            <p class="mb-0" style="font-size: 0.9rem;">5X <b><img src="public/assets/img/icons/zoom.svg"
                                        alt="zoom" class="img-fluid"
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="border-left" style="border-left: 2px solid #007368; height: 50px;"></div>
                        </div>

                        <div class="col-12 col-md d-flex align-items-center mb-3 mb-md-0">
                            <img src="public/assets/img/icons/Video.svg" alt="Clock Icon" class="img-fluid"
                        ...
                        <div class="col-12 col-md d-flex align-items-center mb-3 mb-md-0">
                            <img src="public/assets/img/icons/calender.svg" alt="Format Icon" class="img-fluid"
                                style="width: 28px; height: 28px; vertical-align: middle; margin-right: 10px;">
                            <div>
                        ...
                        <div class="col-12 col-md d-flex align-items-center">
                            ...
                            <img src="public/assets/img/icons/power-bi.png" alt="Tools Icon" class="img-fluid"
    ...
    <section class="faq__area" style="padding-top: 10;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5" data-aos="fade-right" data-aos-delay="400" style="margin-top: -50px;">
                    <div class="container mt-5 d-flex justify-content-center align-items-center" style="height: 85vh;">
                        <div class="align-items-center">
                            <!-- Gambar bagian atas card -->
