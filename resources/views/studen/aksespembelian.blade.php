                                                            ...
                                                            <div
                                                                ...
                                                                <div class="courses__item-content-bottom mt-auto">
                                                                    ...
                                                                    <div class="author-two d-flex align-items-center">
                                                                        <a
                                                                            href="{{ route('profile_instruktur', ['id' => $order->KelasTatapMuka->user->id]) }}">
                                                                            <img src="{{ $order->KelasTatapMuka->user->userprofile && $order->KelasTatapMuka->user->userprofile->gambar
                                                                                ? (strpos($order->KelasTatapMuka->user->userprofile->gambar, 'googleusercontent') !== false
                                                                                    ? $order->KelasTatapMuka->user->userprofile->gambar
                                                                    ...
                                                                    <div class="courses__item-bottom-two">
                                                                        <ul class="list-wrap">
                                                                            <li>{{ $order->KelasTatapMuka->sections->link }}<i
