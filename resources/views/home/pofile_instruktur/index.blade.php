...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Memeriksa apakah ada elemen yang ditemukan
            if (slides.length > 0) {
                slides.forEach(slide => {
                    // Mendapatkan salinan dari elemen slide
                    const clone = slide.cloneNode(true);
                    // Menambahkan salinan ke elemen induk (swiper-wrapper)
                    slide.parentNode.appendChild(clone);
                });
            } else {
                console.log("Tidak ada kelas yang ditemukan untuk instruktur ini.");
            }
        });
    </script>
@endsection
