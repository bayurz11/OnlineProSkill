            ...
            <div class="row justify-content-between align-items-start">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <img src="{{ asset('public/assets/img/logo/logo.svg') }}" alt="Logo" data-aos-delay="800"
                        data-aos="fade-top" class="d-block mb-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap" data-aos="fade-top"
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div>
                                <p class="mb-0"><b>5X</b> <b><img src="public/assets/img/icons/zoom.svg" alt="zoom"
                                            class="zoom-icon"></b> Online</p>
                                <p class="mb-0"><b>Setiap Sabtu</b></p>
                            </div>
                        </div>

                        <div class="d-none d-md-block border-left mx-3"
                            style="border-left: 2px solid #007368; height: 50px;">
                        </div>

                        <div class="d-flex align-items-center mb-3">
                            <img src="public/assets/img/icons/Video.svg" alt="Clock Icon" class="mr-2"
                                style="width: 28px;">
                            <div>
                                <p class="mb-0">50+ Video</p>
                                <p class="mb-0 font-weight-bold">on demand</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/assets/img/icons/calender.svg" alt="Format Icon" class="mr-2"
                                style="width: 28px;">
                            <div>
                                <p class="mb-0">Start:</p>
                                <p class="mb-0 font-weight-bold">30 Nov</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div>
                                <p class="mb-0">In demand</p>
                                <p class="mb-0 font-weight-bold">Tools & Skills</p>
                            </div>
                            <img src="public/assets/img/icons/power-bi.png" alt="Tools Icon" class="ml-2"
                                style="width: 28px;">
                        </div>
                    </div>
                </div>

                <!-- Responsive div for image and other content -->
                <div class="col-lg-5 col-md-6 col-sm-12 mt-5 mt-lg-0">
                    <div class="banner__images d-flex justify-content-center align-items-center position-relative">
                        <!-- Main Image -->
                        <img src="public/assets/img/banner/banner2.jpg" alt="img" class="main-img img-fluid rounded"
                        ...
                        <!-- Wrapper for center content (icons & text) -->
                        <div class="position-absolute d-flex flex-column justify-content-center align-items-center"
                            style="z-index: 102;">
                            <!-- Text above video link -->
                            <span class="font-weight-bold mb-2" style="font-size: 18px; color: #000;">Lihat</span>

                            <!-- Link to open video in modal popup -->
                            ...
                            <!-- Text below video link -->
                            <span class="font-weight-bold mt-2" style="font-size: 18px; color: #000;">Sesi Bootcamp
                                Sebelumnya</span>
                        </div>
                    </div>

                    <!-- Bootcamp Student Info -->
                    <div class="banner__student text-center mt-5" data-aos="fade-left" data-aos-delay="200">
                        <div class="icon mb-2">
