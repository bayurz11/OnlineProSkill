...
<body>
    ...
    <main class="main-area fix">
        ...
        <section class="banner-area-two banner-bg-two tg-motion-effects"
            ...
            <img src="assets/img/banner/h2_banner_shape03.svg" alt="shape" class="line-shape-two"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="features__item-two">
                                ...
                                <div class="features__item-shape">
                                    <img src="assets/img/others/features_item_shape.svg" alt="img"
                                        class="injectable">
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="instructor__content-three">
                                            ...
                                            <div class="tg-button-wrap">
                                                <a href="instructor-details.html" class="btn arrow-btn">Join My
                                                    Class <img src="assets/img/icons/right_arrow.svg" alt="img"
                                                        class="injectable"></a>
                                            </div>
                                        </div>
                                    </div>
