            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb__content">
                        <h3 class="title">Kelas Online</h3>
                        <nav class="breadcrumb">
                            <span property="itemListElement" typeof="ListItem">
                                <a href="{{ route('/') }}">Beranda</a>
                            </span>
                            <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                            <span property="itemListElement" typeof="ListItem">Kelas Online</span>
                        </nav>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="courses__item-content">
                                                    ...
                                                    <p class="author">By <a
                                                        ...
                                                        @if (in_array($cours->id, $joinedCourses))
                                                            <span
                                                                style="color: green; font-weight: bold; padding: 2px 6px; border: 1px solid green; border-radius: 5px; background-color: #e0f7e9;">
                                                                Joined
                                                            </span>
                                                        @endif
                                                    </p>
