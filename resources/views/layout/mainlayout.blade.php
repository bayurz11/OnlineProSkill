...
<body>
    ...
    <main class="main-area fix">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-9">
                        <div class="about__images work__images">
                            ...
                            <img src="public/assets/img/others/about_shape.svg" alt="img"
                    ...
                    <div class="col-lg-6">
                        <div class="work__content">
                            ...
                            <p>Edhen an unknown printer took a galley of type and scrambled it to make a type specimen
                                bookas survived not only five centuries.Edhen an unknown printer took a galley of type
                                and scrambled.</p>
                            ...
                            <div class="tg-button-wrap">
                                <a href="contact.html" class="btn arrow-btn">Quick Join Now <img
                                        src="public/assets/img/icons/right_arrow.svg" alt="img"
                                        class="injectable"></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="fact__inner-wrap-two">
                            ...
                            <div class="fact__img-wrap tg-svg">
                                <img src="public/assets/img/others/fact_img.png" alt="img">
                                <div class="shape-one">
                                    <img src="public/assets/img/others/fact_shape01.svg" alt="img"
                                        class="injectable">
                                </div>
                                <div class="shape-two">
                                    <span class="svg-icon" id="fact-btn"
                                        data-svg-icon="public/assets/img/others/fact_shape02.svg"></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- instructor-area -->
        <section class="instructor__area-three instructor__bg"
            data-background="public/assets/img/bg/instructor_bg.jpg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section__title text-center mb-40">
                        ...
                        <div class="swiper-container instructor-active">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="instructor__item-three">
                                        <div class="instructor__thumb-three">
                                            <img src="public/assets/img/instructor/h2_instructor01.png"
                                                alt="img">
                                            <div class="shape-one">
                                                <img src="public/assets/img/instructor/h2_instructor_img_shape01.svg"
                                        ...
                                        <div class="instructor__content-three">
                                            ...
                                            <div class="tg-button-wrap">
                                                <a href="instructor-details.html" class="btn arrow-btn">Join My
                                                    Class <img src="public/assets/img/icons/right_arrow.svg"
                                ...
                                <div class="swiper-slide">
                                    <div class="instructor__item-three">
                                        <div class="instructor__thumb-three">
                                            <img src="public/assets/img/instructor/h2_instructor02.png"
                                                alt="img">
                                            <div class="shape-one">
                                                <img src="public/assets/img/instructor/h2_instructor_img_shape01.svg"
                                                    alt="img" class="injectable">
                                ...
                                <div class="swiper-slide">
                                    <div class="instructor__item-three">
                                        <div class="instructor__thumb-three">
                                            <img src="public/assets/img/instructor/h2_instructor03.png"
                                                alt="img">
                                            <div class="shape-one">
                                                <img src="public/assets/img/instructor/h2_instructor_img_shape01.svg"
                                                    alt="img" class="injectable">
                                ...
                                <div class="swiper-slide">
                                    <div class="instructor__item-three">
                                        <div class="instructor__thumb-three">
                                            <img src="public/assets/img/instructor/h2_instructor04.png"
                                                alt="img">
                                            <div class="shape-one">
                                                <img src="public/assets/img/instructor/h2_instructor_img_shape01.svg"
                                                    alt="img" class="injectable">
                                ...
                                <div class="swiper-slide">
                                    <div class="instructor__item-three">
                                        <div class="instructor__thumb-three">
                                            <img src="public/assets/img/instructor/h2_instructor05.png"
                                                alt="img">
                                            <div class="shape-one">
                                                <img src="public/assets/img/instructor/h2_instructor_img_shape01.svg"
                                                    alt="img" class="injectable">
                    ...
                    <div class="col-xl-9">
                        <div class="instructor-slider-dot">
                            <div class="swiper instructor-nav">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <button><img src="public/assets/img/instructor/instructor_nav01.png"
                                                alt="img"></button>
                                    </div>
                                    <div class="swiper-slide">
                                        <button><img src="public/assets/img/instructor/instructor_nav02.png"
                                                alt="img"></button>
                                    </div>
                                    <div class="swiper-slide">
                                        <button><img src="public/assets/img/instructor/instructor_nav03.png"
                                                alt="img"></button>
                                    </div>
                                    <div class="swiper-slide">
                                        <button><img src="public/assets/img/instructor/instructor_nav04.png"
                                                alt="img"></button>
                                    </div>
                                    <div class="swiper-slide">
                                        <button><img src="public/assets/img/instructor/h2_instructor05.png"
                                                alt="img"></button>
                                    </div>
                                    <div class="swiper-slide">
                                        <button><img src="public/assets/img/instructor/instructor_nav04.png"
            ...
            <div class="instructor__shape">
                <img src="public/assets/img/instructor/h2_instructor_shape.png" alt="img"
        ...
        <section class="newsletter__area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="newsletter__img-wrap">
                            <img src="public/assets/img/others/newsletter_img.png" alt="img">
                            <img src="public/assets/img/others/newsletter_shape01.png" alt="img"
                                data-aos="fade-up" data-aos-delay="400">
                            <img src="public/assets/img/others/newsletter_shape02.png" alt="img"
                                class="alltuchtopdown">
                        </div>
                    </div>
                    <div class="col-lg-8">
            ...
            <div class="newsletter__shape">
                <img src="public/assets/img/others/newsletter_shape03.png" alt="img" data-aos="fade-left"
                    data-aos-delay="400">
            </div>
        </section>
        <!-- newsletter-area-end -->
                                        ...
                                        <div class="event__item shine__animate-item">
                                            <div class="event__item-thumb">
                                                <a href="events-details.html" class="shine__animate-link"><img
                                                        src="public/assets/img/events/event_thumb01.jpg"
                                                        alt="img"></a>
                                            </div>
                                            <div class="event__item-content">
                                                ...
                                                <a href="https://maps.google.com/maps" class="location"
                                                    target="_blank"><i class="flaticon-map"></i>United Kingdom</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="event__item shine__animate-item">
                                            <div class="event__item-thumb">
                                                <a href="events-details.html" class="shine__animate-link"><img
                                                        src="public/assets/img/events/event_thumb02.jpg"
                                                        alt="img"></a>
                                            </div>
                                            <div class="event__item-content">
                                                <span class="date">25 June, 2024</span>
                                                ...
                                                <a href="https://maps.google.com/maps" class="location"
                                                    target="_blank"><i class="flaticon-map"></i>Tokyo Japan</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="event__item shine__animate-item">
                                            <div class="event__item-thumb">
                                                <a href="events-details.html" class="shine__animate-link"><img
                                                        src="public/assets/img/events/event_thumb03.jpg"
                                                        alt="img"></a>
                                            </div>
                                            <div class="event__item-content">
                                                <span class="date">25 June, 2024</span>
                                                ...
                                                <a href="https://maps.google.com/maps" class="location"
                                                    target="_blank"><i class="flaticon-map"></i>New Work</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="instructor__item-wrap-two">
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="instructor__item-two tg-svg">
                                <div class="instructor__thumb-two">
                                    ...
                                    <div class="shape-one">
                                        <img src="public/assets/img/instructor/instructor_shape01.svg"
                                            alt="img" class="injectable">
                                    </div>
                                    <div class="shape-two">
                        ...
                        <div class="col-xl-6">
                            <div class="instructor__item-two tg-svg">
                                <div class="instructor__thumb-two">
                                    <img src="public/assets/img/instructor/instructor_two02.png" alt="img">
                                    <div class="shape-one">
                                        <img src="public/assets/img/instructor/instructor_shape01.svg"
                                            alt="img" class="injectable">
                                    </div>
