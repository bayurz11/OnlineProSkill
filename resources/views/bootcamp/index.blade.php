            ...
            <div class="row justify-content-between align-items-start" style="display: flex; flex-wrap: wrap;">
                ...
                <div class="col-lg-5" style="position: relative;">
                    <div class="banner__images"
                        style="position: relative; display: flex; justify-content: center; align-items: center; margin-top: 160px; margin-left: 60px;">
                        <!-- Background Image -->
                    ...
                    <div class="banner__student mt-4 mt-md-5" data-aos="fade-left" data-aos-delay="200"
                        style="z-index: 100;">
                        <div class="icon">
