...
<link rel="stylesheet" href="{{ asset('public/assets_admin/vendors/flatpickr/flatpickr.min.css') }}">
...
<!-- End layout styles -->
<!-- Plugin css for this page -->
<link rel="stylesheet" href="{{ asset('public/assets_admin/vendors/select2/select2.min.css') }}">
...
<!-- Plugin css for this page -->
<link rel="stylesheet" href="{{ asset('public/assets_admin/vendors/datatables.net-bs5/dataTables.bootstrap5.css') }}">
<!-- End plugin css for this page -->

<!-- Plugin css for this page -->
<link rel="stylesheet" href="{{ asset('public/assets_admin/vendors/easymde/easymde.min.css') }}">
<!-- End plugin css for this page -->
