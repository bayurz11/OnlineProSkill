                    ...
                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="courses__item shine__animate-item">
                                                <div class="courses__item-thumb">
                                                    <a href="{{ route('classroomdetail', ['id' => $cours->id]) }}"
                                                        ...
                                                        <img src="{{ asset('public/assets/img/classroom/kelas.png') }}"
                                                            alt="img">
                                                    </a>
                                                </div>
                                                <div class="courses__item-content">
                                                    ...
                                                    <div
                                                        class="course__bottom d-flex align-items-center justify-content-between">
                                                        <div class="course__action">
                                                            <ul class="list-wrap">
                                                                <li class="wishlist"><a href="javascript:void(0);"><i
                                                                            class="far fa-heart"></i></a></li>
                                                                <li class="compare"><a href="javascript:void(0);"><i
                                                                            class="fas fa-exchange-alt"></i></a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="price">
                                                            <span>Rp {{ number_format($cours->harga, 0, ',', '.') }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="courses__item-overlay">
                                                        <a href="{{ route('classroomdetail', ['id' => $cours->id]) }}"
                                                            class="shine__animate-item-btn">Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="list" role="tabpanel" aria-labelledby="list-tab">
                            <div class="courses__list-wrap">
                                @foreach ($course as $cours)
                                    @if ($cours->status == 1 && $jumlahPendaftaran->get($cours->id, 0) < 8)
                                        <div class="courses__item courses__list-item shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="{{ route('classroomdetail', ['id' => $cours->id]) }}"
                                                    class="shine__animate-link">
                                                    <img src="{{ asset('public/assets/img/classroom/kelas.png') }}"
                                            ...
                                            <div class="courses__item-content">
                                                <div class="course__title">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <span style="font-size: 13px;">
                                                                {{ $cours->waktu_mulai }} - {{ $cours->waktu_selesai }}
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
